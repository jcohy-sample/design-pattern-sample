...
.Prototype
----
include::{java-code}/prototype/Prototype.java[tag=code]
----
...
.ConcretePrototype
----
include::{java-code}/prototype/ConcretePrototype.java[tag=code]
----
...
.Test
----
include::{java-code}/prototype/Test.java[tag=code]
----
