...
.Java
----
include::{java-code}/flyweight/BigChar.java[tag=code]
----
...
.Java
----
include::{java-code}/flyweight/BigString.java[tag=code]
----
...
.Java
----
include::{java-code}/flyweight/BigCharFactory.java[tag=code]
----
...
.Java
----
include::{java-code}/flyweight/Client.java[tag=code]
----
