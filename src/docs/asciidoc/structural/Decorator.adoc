...
.Display
----
include::{java-code}/decorator/example2/Display.java[tag=code]
----
...
.StringDisplay
----
include::{java-code}/decorator/example2/StringDisplay.java[tag=code]
----
...
.Border
----
include::{java-code}/decorator/example2/Border.java[tag=code]
----
...
.SideBorder
----
include::{java-code}/decorator/example2/SideBorder.java[tag=code]
----
...
.FullBorder
----
include::{java-code}/decorator/example2/FullBorder.java[tag=code]
----
...
.Test
----
include::{java-code}/decorator/example2/Test.java[tag=code]
----
