...
.Subject
----
include::{java-code}/proxy/example2/Subject.java[tag=code]
----
...
.RealSubject
----
include::{java-code}/proxy/example2/RealSubject.java[tag=code]
----
...
.Proxy
----
include::{java-code}/proxy/example2/Proxy.java[tag=code]
----
...
.Client
----
include::{java-code}/proxy/example2/Client.java[tag=code]
----
