...
image::{oss-images}/design-pattern-template-method.png[]
...
.AbstractDisplay
----
include::{java-code}/templatemethod/AbstractDisplay.java[tag=code]
----
...
.CharDisplay
----
include::{java-code}/templatemethod/CharDisplay.java[tag=code]
----
.StringDisplay
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
----
include::{java-code}/templatemethod/StringDisplay.java[tag=code]
----
...
.Client
----
include::{java-code}/templatemethod/Client.java[tag=code]
----
