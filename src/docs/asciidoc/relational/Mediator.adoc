...
image::{oss-images}/relational/design-mediator.png[]
...
.Colleague
----
include::{java-code}/mediator/Colleague.java[tag=code]
----
...
.ColleagueButton
----
include::{java-code}/mediator/ColleagueButton.java[tag=code]
----
.ColleagueCheckbox
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
----
include::{java-code}/mediator/ColleagueCheckbox.java[tag=code]
----
.ColleagueTextFiled
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
----
include::{java-code}/mediator/ColleagueTextFiled.java[tag=code]
----
...
.Mediator
----
include::{java-code}/mediator/Mediator.java[tag=code]
----
...
.LoginFrame
----
include::{java-code}/mediator/LoginFrame.java[tag=code]
----
...
.Client
----
include::{java-code}/mediator/Client.java[tag=code]
----
